...
mkTKTForKernel = kernel: let
  ...
  in  {
    ...
    "linuxPackages_${_major_minor_ersion}-tkt" = linuxPackagesFor kernels."linux_${_major_minor_ersion}-tkt";
    "linuxPackages_${_major_minor_ersion}-tkt_clang" = linuxPackagesFor kernels."linux_${_major_minor_ersion}-tkt_clang";
